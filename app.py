...
def load_models():
    ...
    return {
        "heart": joblib.load(os.path.join(base, "heart.pkl")),
        "diabetes": joblib.load(os.path.join(base, "diabetes.pkl")),
        "obesity": joblib.load(os.path.join(base, "obesity.pkl")),
        "hypertension": joblib.load(os.path.join(base, "hypertension.pkl"))
    }
