...
def load_models():
    ...
    folder_url = "https://drive.google.com/drive/folders/1MVmcOG-MABWrYZeP5g4lmINiHEg2bLH3"

    # Download entire folder (only first time)
    if not os.path.exists("models"):
        gdown.download_folder(folder_url, output="models", quiet=False)

    return {
        "heart": joblib.load("models/heart.pkl"),
        "diabetes": joblib.load("models/diabetes.pkl"),
        "obesity": joblib.load("models/obesity.pkl"),
